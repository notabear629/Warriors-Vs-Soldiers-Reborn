...
class userInfoManager:
    ...
    async def getDefaultStatistics():
        ...
        for role in Role.allLethal:
            ...
            stats.update(roleStats)
        abilityStats = {'JeanForces':0, 'JeanForceWins':0, 'ZacharyVetoes':0, 'ZacharyVetoWins':0, 'ErwinFlaresFired': 0, 'DazChickens':0, 'DazChickenWins': 0, 'LeviAttacks':0, 'LeviKills':0, 'LeviDefends':0, 'LeviDefendWins':0,  'MikasaGuards': 0, 'MikasaSaved': 0, 'MikasaSaveWins':0, 'PetraWatches': 0, 'PetraKills': 0, 'MikeSmells': 0, 'FlochDetects': 0, 'HitchDiscovers': 0, 'NileSightings':0, 'ConnieAlerts':0, 'ArminNukes': 0, 'SashaFires': 0, 'KeithFinishedPlayed': 0, 'KeithFinishedWon': 0, 'KeithFinishedKidnaps': 0, 'KeithFinishedKidnapWins':0,'GabiFires' : 0,  'GabiFireWins': 0, 'AnnieScreams' : 0, 'PieckFlipAccepts' : 0, 'PieckFlipRejects' : 0, 'PieckFlipAcceptWins': 0, 'PieckFlipRejectWins': 0, 'PorcoGags': 0, 'PorcoCommanderSkips':0, 'FalcoUses' :0, 'FalcoVoteWins':0, 'ReinerSaves': 0, 'BertholdtCloaks': 0, 'BertholdtDoubleCloaks': 0}
