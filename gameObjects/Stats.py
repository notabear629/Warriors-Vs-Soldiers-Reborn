...
class Stats:
    ...
    def processKill(self, killer, killed):
        solKillRoles = ['Levi', 'Sasha', 'Armin', 'Petra', 'Pyxis', 'Rico', 'Frecklemir']
        ...
        if killer.role.id in solKillRoles:
            ...
            if killer.role.id in solKillRoles and killed.role.team == 'Warriors':
